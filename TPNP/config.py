...
API_ROOT = 'http://127.0.0.1:55700'     #
RSS_PROXY = '127.0.0.1:1081'    # 代理地址
ROOTUSER=[**********]    # 管理员qq,支持多管理员，逗号分隔 如 [1,2,3] 注意，启动消息只发送给第一个管理员
DEBUG = False
RSSHUB='http://168.138.35.3:61200'     # rsshub订阅地址
...
IsLinux=True # 如果你是Linux部署的，即使用了 docker 部署，请打开此项并设置 Linux_Path
